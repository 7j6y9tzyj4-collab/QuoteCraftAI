...
export const categories=["Ванна: повний ремонт","Кухня: повний ремонт","Ванна: обладнання","Демонтаж і прибирання","Двері","Гіпсокартон","Електрика та вентиляція","Підлога","Утеплення","Кухня","Фарбування та підготовка","Сантехніка","Плитка та гідроізоляція","Столярні роботи","Інші роботи"];
export function categoryOf(p:PriceRule):string{
 // Категорію з чужого каталогу (не з нашого списку) не показуємо окремою групою
 ...
 if(/prefab|acrylic_tub|freestanding_tub|bathtub_remove/.test(id))return "Ванна: обладнання";
 if(/drywall|skim|wood_frame|framing/.test(id))return "Гіпсокартон";
 ...
 if(/baseboard|trim|quarter_round|casing|molding|caulk|shelf/.test(id))return "Столярні роботи";
