...
export const categories=["Фарбування та підготовка","Гіпсокартон","Плитка та гідроізоляція","Підлога","Сантехніка","Електрика та вентиляція","Двері та столярні роботи","Скло та аксесуари","Кухня","Демонтаж і прибирання","Інші роботи"];
