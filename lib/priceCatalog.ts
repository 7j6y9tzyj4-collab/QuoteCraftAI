...
export const categories=["Ванна: повний ремонт","Ванна: обладнання","Демонтаж і прибирання","Двері","Гіпсокартон","Електрика та вентиляція","Підлога","Утеплення","Кухня","Фарбування та підготовка","Сантехніка","Плитка та гідроізоляція","Столярні роботи","Інші роботи"];
