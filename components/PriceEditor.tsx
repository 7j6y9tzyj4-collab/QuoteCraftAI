...
export default function PriceEditor({prices,onSave}:Props){
 ...
 return <div>
  ...
  <button className="secondary full" disabled={saving} onClick={()=>replace(applyChicagoPrices(draft))}>Застосувати перевірені ставки Чикаго ({Object.keys(chicagoPrices).length} позицій)</button>
